...
def conectar():
    ...
    except mysql.connector as erro: #Guardando as possíveis exceções na variáveis erro
        if erro.errno == errorcode.ER_BAD_DB_ERROR: #Caso o banco de dados não exista
            print('Banco de dados não existe!, {}'.format(erro))
        elif erro.errno == errorcode.ER_ACCESS_DENIED_ERROR: #Caso o usuário ou senha
